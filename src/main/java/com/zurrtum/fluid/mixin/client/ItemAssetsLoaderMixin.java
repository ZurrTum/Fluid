...
public class ItemAssetsLoaderMixin {
    ...
    private static CompletableFuture<ItemAssetsLoader.Result> loadItemAssets(
        CompletableFuture<Map<Identifier, Resource>> instance,
        Function<Map<Identifier, Resource>, CompletionStage<ItemAssetsLoader.Result>> fn,
        Operation<CompletableFuture<ItemAssetsLoader.Result>> original
    ) {
